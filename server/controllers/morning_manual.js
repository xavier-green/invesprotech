...
exports.getTreatedTransactions = (req, res, next) => {
	...
	var today_date = req.params['0'] || null;

	today = moment(today_date,"DD-MM-YYYY").format("DD/MM/YYYY")

	console.log("getting data, today= "+today);

	updateTreatedTransactions([],req, res, next)
